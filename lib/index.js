...
function connect(Composed) {
  return (function (superclass) {
    ...
    Connect.prototype.componentDidMount = function componentDidMount () {
      this.token = xander.subscribe(this.handleChange);
      Default;
    };
    ...
    Connect.prototype.handleChange = function handleChange (state) {
      this.setState(state);
    };
...
var render$1 = function (options, rootEl) {
  ...
  reactDom.render(React.createElement(App(options)), rootEl);
};
